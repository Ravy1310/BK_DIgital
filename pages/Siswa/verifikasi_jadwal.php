        ...
        <div class="col-md-6">
            <div class="card-custom">
                ...
                <p class="text-center mt-2 mb-4">
                    NIS diperlukan untuk menyimpan data pengajuan jadwal konsultasi anda agar tercatat dengan benar
                </p>

                <input type="text" class="form-control mb-3" placeholder="Nomor Induk Siswa (NIS)">
                <div class="text-center">
                    <button class="btn btn-custom">Ajukan Jadwal Sekarang</button>
                </div>
            </div>
        </div>
