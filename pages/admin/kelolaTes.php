    ...
    <div class="card p-3 shadow-sm tes-card mb-3">
      <div class="d-flex align-items-center">
        ...
        <div>
          ...
          <p class="text-muted mb-0"><?php echo htmlspecialchars($tes['deskripsi_tes']); ?><br><?php echo $tes['jumlah_soal']; ?> soal</p>
        </div>
      </div>
    </div>
  <?php
    ...
    echo '<div class="alert alert-warning">Gagal memuat daftar tes</div>';
  }
  ?>
</div>
  <!-- JavaScript -->
